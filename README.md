...
|-----------------------| ---- | ------ | ---- |----------|------------------------------|----------|
| Convolution           | ❌    | ❌      | ❌    | ❌ 已实现    | 卷积                           | ❌ 未测试    |
| ReLU                  | ✅    | ❌      | ❌    | ✅ 已实现    | 激活                           | ✅ 已测试    |
| Reshape               | ❌    | ❌      | ❌    | ❌ 未实现    | 维度变换                         | ❌ 未测试    |
| InnerProduct          | ✅    | ❌      | ❌    | ❌ 未实现    | 全连接                          | ❌ 未测试    |
| AbsVal                | ✅    | ❌      | ❌    | ❌ 未实现    | 绝对值                          | ❌ 未测试    |
| ArgMax                | ❌    | ❌      | ❌    | ❌ 未实现    | 最大值索引/Top-k                  | ❌ 未测试    |
| BatchNorm             | ✅    | ❌      | ❌    | ❌ 未实现    | 批归一化                         | ❌ 未测试    |
| Bias                  | ✅    | ✅      | ✅    | ✅ 已实现    | 加偏置                          | ✅ 已测试    |
| BinaryOp              | ✅    | ❌      | ❌    | ❌ 未实现    | 二元算子                         | ❌ 未测试    |
| BNLL                  | ✅    | ❌      | ❌    | ❌ 未实现    | 双曲对数激活                       | ❌ 未测试    |
| Cast                  | ✅    | ✅      | ✅    | ❌ 未实现    | 类型转换                         | ❌ 未测试    |
| Celu                  | ✅    | ❌      | ❌    | ❌ 未实现    | 指数激活                         | ❌ 未测试    |
| Clip                  | ✅    | ❌      | ❌    | ✅ 已实现    | 限幅                           | ✅ 已测试    |
...
| SELU                  | ✅    | ❌      | ❌    | ✅ 已实现    | SELU 激活                      | ✅ 已测试    |
| Shrink                | ❌    | ❌      | ❌    | ❌ 未实现    | Shrink                       | ❌ 未测试    |
| ShuffleChannel        | ❌    | ❌      | ❌    | ❌ 未实现    | 通道打散                         | ❌ 未测试    |
| Sigmoid               | ✅    | ❌      | ❌    | ✅ 已实现    | Sigmoid 激活                   | ✅ 已测试    |
| Slice                 | ❌    | ❌      | ❌    | ❌ 未实现    | Slice                        | ❌ 未测试    |
| Softmax               | ✅    | ❌      | ❌    | ✅ 已实现    | Softmax                      | ✅ 已测试    |
