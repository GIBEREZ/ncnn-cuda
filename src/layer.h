...
public:
    ...
    virtual int forward_inplace(CudaMat& input_blob, const Option& opt) const;
    virtual int forward_inplace(std::vector<CudaMat>& input_blobs, const Option& opt) const;
#endif
